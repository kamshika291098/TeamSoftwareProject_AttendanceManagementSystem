...
<div class="col-xl-3 col-md-6 mb-6 mx-auto">
	...
	<div class="card card-outline card-dark text-center mb-3 " style="width: 60rem; border-color: rgba(86,138,161);">
	    <div class="card-header bg-transparent">
		<h4 style="color: rgba(86,138,161);">Welcome to AMS Login </h4>
		<i class="fa fa-solid fa-user fa-3x fa-beat-fade" style="color: rgba(86,138,161); --fa-animation-duration: 3s;"></i>
	    </div>
        ...
        @endif
	    <div class="card-body card-outline card-dark text-center mb-3 " style="border-color: rgba(86,138,161);">
			...
			<div class="row">
				<p>
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" style="border-color: rgba(86,138,161);" name="username" placeholder="UserName"/>
					</div>	
					</div>
					</div>
				</p>
				<p>
					...
					<div class="input-group mb-3">
						...
						<input type="password" class="form-control" style="border-color: rgba(86,138,161);" name="password" placeholder="Password"/>
					</div>
					</div>
					</div>
				...
				<p>
					<div class="form-group">              
						<button type="submit" class="btn btn-block" style="background-color: rgba(86,138,161); color:white"><i class="fas fa-users"></i> Login</button>
					<div>
				<p>
			</div>	
			</form>
